    ...
    return (
      <div className="authCheck_container">
        ...
        <div className="authCheck_num_div">
          <input className="authCheck_num" id="g1" onKeyUp="hh(1);"></input>
          <input className="authCheck_num" id="g2"></input>
          <input className="authCheck_num" id="g3"></input>
          <input className="authCheck_num" id="g4"></input>
          <input className="authCheck_num" id="g5"></input>
        </div>
