          ...
          <div>
            ...
            <div className="div1">
              ...
              <div className="detail_content">
                ...
                시작하겠습니다. 다들 활짝 웃어 주세요 감정 인식하고 있습니다. 네
                어 정말 이게 힘드네요. 지금 안 뜨고 있어요 더 웃어 주세요.
                이렇게 말이 끊겨요 뜹니다. 윤영 씨가 작품 소개와 작 품의 기대
                효과에 대해서 간략하게 말씀해 주실 수 있을까요. 언제 뜨나요
                감정은. 와우 협업플랫폼. 와 우 협업플랫폼 뭐야. 아우 대단하네요
                나네 좀 아 이게 근데 그것 좀.
              </div>
            </div>
            <br />
            <div className="div2">
              ...
              <div className="detail_content">
                ...
                인식하고 구글 오늘 거쳐 돈이되는 주제에 대한 종합 반응을 실시간
                으로 분석하여 의견의 지지율을 의사결정의 객관적 활용하고자 합니
                다. 잘한다 표정 무서워요 아. 구정에 해당하는 얼굴표정을 수집 해
                학습 데이터로 활용하고 학습시키는 방식으로 진행하였습니다. 영어
                발음이 놀라워요. 내 발음 좀 인정 받았나 봐.
              </div>
            </div>
            <br />
          </div>
